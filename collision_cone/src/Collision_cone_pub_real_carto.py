...
def tf_pose_callback(event):
    ...
    try:
        ...
        orientation_x = transform_stamped.transform.rotation.x
        orientation_y = transform_stamped.transform.rotation.y
        orientation_z = transform_stamped.transform.rotation.z
        orientation_w = transform_stamped.transform.rotation.w
