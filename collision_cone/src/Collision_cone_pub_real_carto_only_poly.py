...
def beta_position_calculator(msg):
    global x_0, y_0
    ...
    x_0 = (x[0] + x[1] + x[2] + x[3]) / 4
    y_0 = (y[0] + y[1] + y[2] + y[3]) / 4

    return x_0, y_0

def tf_pose_callback(msg):
    global x_0, y_0, x_1, y_1, r, alpha_1, alpha_2, v_0, v_1, beta

    x = [msg.polygon.points[0].x, msg.polygon.points[1].x, msg.polygon.points[2].x, msg.polygon.points[3].x]
    y = [msg.polygon.points[0].y, msg.polygon.points[1].y, msg.polygon.points[2].y, msg.polygon.points[3].y]
    x_1 = (x[0] + x[1] + x[2] + x[3]) / 4
    y_1 = (y[0] + y[1] + y[2] + y[3]) / 4
...
def collision_cone_calculator():
    ...
    rospy.Subscriber("move_base/global_costmap/footprint",PolygonStamped, beta_position_calculator)
    rospy.Subscriber("/tb3_0/move_base/global_costmap/footprint",PolygonStamped, tf_pose_callback)    
...
if __name__ == '__main__':
    try:
        rospy.init_node('collision_cone_node_nons')
